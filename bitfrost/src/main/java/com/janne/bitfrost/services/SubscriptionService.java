...
public class SubscriptionService {
    ...
    public void approveAccessRequest(String requestId) {
        Subscription subscription = subscriptionRepository.findById(requestId).orElseThrow(() -> new ResponseStatusException(HttpStatus.NOT_FOUND, "Access request not found"));
    ...
    public Subscription getAccessRequest(String accessRequestId) {
        return subscriptionRepository.findById(accessRequestId).orElseThrow(() -> new ResponseStatusException(HttpStatus.NOT_FOUND, "Access request not found"));
    }
