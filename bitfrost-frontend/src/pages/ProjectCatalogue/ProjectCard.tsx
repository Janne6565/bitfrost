...
export default function ProjectCard({ project, onSubscribe, openDetailModal }: ProjectCardProps) {
  return (
    <Card
      variant="outlined"
...
<Button
  ...
  sx={{
    ...
    borderRadius: 'md',
    //color: '#000000ff',
    transition: 'background-position 0.4s ease-in-out, box-shadow 0.2s',
    '&:hover': {
      background: 'linear-gradient(270deg, #FB3F2E, #FFB813, #2CC589, #178AEC, #9933ff, #ff33cc, #FB3F2E, #FFB813, #2CC589)',
